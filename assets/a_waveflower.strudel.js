...
$: seq
  .note()
  .mask(`<1 0 0 0 1>`.slow(4))
  .s('sawtooth')
  .set.mix('<.8 .8 .8 .67>'.vel())
  .jitrans(seq)
  .gain(1 / 2)
  ._scope();
$: seq
  .note()
  .mask(`<0 1 0 0 0>`.slow(4))
  .s('z_tan')
  .set.mix('<.8 1 1 .67>'.vel())
  .jitrans(seq)
  .gain(1 / 2)
  ._scope();
...
$: seq
  .note()
  .mask(`<0 0 0 1 0>`.slow(4))
  .s('z_tan')
  .set.mix('<.8 1 .67 .67>'.vel())
  .jitrans(seq)
  .gain(1 / 2)
  ._scope();
$: seq
  .note()
  .mask(`<0 0 1 0 0>`.slow(4))
  .s('z_tan')
  .set.mix('<1 1 .67 .67>'.vel())
  .jitrans(seq)
  .gain(1 / 2)
  ._scope();
